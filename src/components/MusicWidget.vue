  ...
  <div class="music-widget">
    ...
    <div class="music-right">
        ...
        <div class="music-other">
            ...
            <svg t="1680000000001" @click="changePlayMode()" v-show="(playMode == 4)" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" width="200" height="200"><path d="M512 890.9L142.8 521.7C77.3 456.2 77.3 349.4 142.8 283.9s165.8-65.5 231.3 0L512 421.8l137.9-137.9c65.5-65.5 172.3-65.5 237.8 0s65.5 172.3 0 237.8L512 890.9z" fill="#E5404F"/></svg>
