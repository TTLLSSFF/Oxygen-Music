...
<template>
  <div class="library-content">
    <RecycleScroller
      ...
      v-slot="{ item, index }"
    >
      <div class="list-item" :class="{'list-item-playing': songId == item.id, 'list-item-disabled': item.playable !== undefined && !item.playable, 'list-item-vip': item.vipOnly}" @dblclick="play(item, index)" @contextmenu.prevent="openMenu($event,item)">
